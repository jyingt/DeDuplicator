...
//	}
	...
	public void findDiff(String str1, String str2, int startpos) {
		...
		while (str1.charAt(i) == str2.charAt(i)) {
			if (i == len1 && i < len2) {
				// System.out.println((len2 - len1) + " chars " +
				// str2.substring(i+1) + " inserted at " + len1 +
				// " on string1");
				...
				// System.out.println((len1 - len2) + " chars " +
				// str1.substring(i+1) + " deleted at " + len2 + " on string1");
		...
		// this is the place where we start to diverge
		// here both diffptr and i means the total size of identical section
		// from the start
...
//		System.out.println("window is " + window)
		...
		if (((index1 = window1.indexOf(str1.charAt(i))) != -1)) {
			...
			//System.out.println(del + " del-tmp " + tmp);
